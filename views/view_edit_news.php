<div class="news">
    <form action="/admin_panel/update_news/?ID=<?php echo $data[0]['ID']?>" method="POST" enctype="multipart/form-data">
        ...
        <label for="headline"> Заголовок: </label> <br><input required  value="<?php echo $data[0]['headline']?>" type="text" name="headline" id="headline"  style="border-style:none; border: 1px solid #c3c3c3; background: #F1F1F1; width: 50%; height: 30px; padding:5px;"><br><br>
        ...
        <br>
        <div class="edit_img">
            <img src='/uploads/<?php echo $data[0]['img']?>' width='125' height='160'>
            <a href="/admin_panel/delete_img/?img=<?php echo $data[0]['img']?>&ID=<?php echo $data[0]['ID']?>" target="_blank"><img  style="margin-top: 70px; border: 1px solid #ddd; margin-left: -8px" src='/style/images/delete.png' alt="Удалить" width="20" height="20" title="Удалить изображение"></a>
        </div>
        <br><hr>
