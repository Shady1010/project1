...
<form action="/admin_panel/add_news" method="POST" enctype="multipart/form-data">
    ...
    <label for="headline"> Заголовок: </label> <br><input type="text" name="headline" id="headline"  style="border-style:none; border: 1px solid #c3c3c3; background: #F1F1F1; width: 50%; height: 30px;"><br><br>
